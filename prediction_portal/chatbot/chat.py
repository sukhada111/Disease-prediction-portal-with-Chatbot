...
response_dict={
     ...
     'workplace_depr' : ["That's Sad! We all have good, bad, ugly and worse days in our lives. Consider this as one of those bad days and move on. Remember that for being successful, one needs to overcome his own failures and fears.", "Sorry to hear that. Managing your work can be tough at times, however, communicating your problems with your superiors might be helpful.", "You must not start feeling demotivated to depressed, instead share your thoughts with your colleagues and bosses, I am sure, they would respect them.",  "I think you are stressing too much on your work. Remember that work is just a part of your life, not your life. Your body, family and other responsibilities deserve as much attention as your work. Try and prioritise on things. These problems in work would get solved one day or another, but problems and diseases caused by mental health issues can be irreversible."],
